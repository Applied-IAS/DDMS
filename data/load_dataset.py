...
def load_dataset(data_config):
    ...
    print('this is a test', data_path)
    ...
    if dataset_name == "kth_actions":
        ...
        train = Simulation(
            os.path.join(data_path, "simulation", "vortex.npy"), data_config["sequence_length"], True, data_config["img_size"]
        )
        val = Simulation(
        ...
        # train_data_dir = '/mnt/sda/daikuai/process_FY-4A_data/nature_256_satellite_images/train'
        # test_data_dir = '/mnt/sda/daikuai/process_FY-4A_data/nature_256_satellite_images/test'
        test_data_dir = './samples'
        # train_data_dir = '/mnt/daikuai/256_satellite_images/test'
        # test_data_dir = '/home/ices/daikuai/64_satellite_images/test'
        # test_data_dir = '/mnt/daikuai/new_china_satellite_images_202006_24'

        # train = Satellite(train_data_dir, 24, train=True)
        # val = Satellite(test_data_dir, 24, train=False)
        val = Satellite_Whole(test_data_dir, 24, train=False)

        # print('length of training samples', len(train))
        # print('length of val samples', len(val))
        # val = Satellite_Whole(test_data_dir, 24, train=False)
